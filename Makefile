...
# TA-TODO: Put your application name here. KrithikaChockalingamGBAGame
...
OFILES = gba.o font.o main.o images/garbage.o images/win.o images/lose.o images/planet.o images/start.o images/rocket.o
